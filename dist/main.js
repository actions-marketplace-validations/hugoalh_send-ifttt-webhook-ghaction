...
/* harmony import */ var _hugoalh_advanced_determine__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(1819);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(2262);
...
try {
	...
	let arbitrary = (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getBooleanInput)("arbitrary");
	...
	(0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.startGroup)(`Post network request to IFTTT.`);
	let response = await (0,node_fetch__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)(`https://maker.ifttt.com/trigger/${eventName}${arbitrary ? "/json" : ""}/with/key/${key}`, {
